            ...
            if (externalDeclaration.getFunctionDefinition() != null){
                ...
                if (funcName.equals("main")){
                    ...
                    while (symbolTable != null) {
                        for (SymbolTableItem symbolTableItem : symbolTable.items.values()) {
                            if (symbolTableItem instanceof FuncDecSymbolTableItem && !symbolTableItem.isUsed()) {
                                changed = changed | translationUnit.removeFuncDec(((FuncDecSymbolTableItem) symbolTableItem).getFuncDec());
                            }
                        }
