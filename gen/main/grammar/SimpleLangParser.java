...
public class SimpleLangParser extends Parser {
	...
	public static final int
		...
		T__9=10, MAIN=11, TYPE=12, IF=13, ELSE=14, RETURN=15, INT_VAL=16, CHAR_VAL=17, 
		STR_VAL=18, BOOL_VAL=19, DOUBLE_VAL=20, LBRACE=21, RBRACE=22, SEMI=23, 
		ASSIGN=24, PLUS=25, LPAR=26, RPAR=27, ID=28, WHITE_SPACE=29, LINE_COMMENT=30, 
		BLOCK_COMMENT=31;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'FuncDec'", "'++'", "'--'", "'*'", "'/'", "'-'", "'=='", "'>='", 
			"'&&'", "'||'", "'main'", null, "'if'", "'else'", "'return'", null, null, 
			null, null, null, "'{'", "'}'", "';'", "'='", "'+'", "'('", "')'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"TYPE", "IF", "ELSE", "RETURN", "INT_VAL", "CHAR_VAL", "STR_VAL", "BOOL_VAL", 
			"DOUBLE_VAL", "LBRACE", "RBRACE", "SEMI", "ASSIGN", "PLUS", "LPAR", "RPAR", 
			"ID", "WHITE_SPACE", "LINE_COMMENT", "BLOCK_COMMENT"
		};
	}
	...
	public final Func_decContext func_dec() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 268480512L) != 0)) {
				{
				{
				setState(40);
	...
	public static class ExprContext extends ParserRuleContext {
		...
		public ExprContext e03;
		public ExprContext e01;
		public Func_callContext f;
		...
		public Token op02;
		public ExprContext e04;
		public Token op01;
		public ExprContext e02;
		public Token op1;
		public Func_callContext func_call() {
			return getRuleContext(Func_callContext.class,0);
		}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(127);
						((ExprContext)_localctx).e3 = expr(7);
					...
					case 2:
						...
						setState(132);
						((ExprContext)_localctx).e5 = expr(6);
					...
					case 3:
						{
						_localctx = new ExprContext(_parentctx, _parentState);
						_localctx.e03 = _prevctx;
						pushNewRecursionContext(_localctx, _startState, RULE_expr);
						setState(135);
						if (!(precpred(_ctx, 4))) throw new FailedPredicateException(this, "precpred(_ctx, 4)");
						setState(136);
						((ExprContext)_localctx).op02 = _input.LT(1);
						_la = _input.LA(1);
						if ( !(_la==T__6 || _la==T__7) ) {
							((ExprContext)_localctx).op02 = (Token)_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
							_errHandler.reportMatch(this);
						...
						setState(137);
						((ExprContext)_localctx).e04 = expr(5);

						                           BinaryOperator  op = ((((ExprContext)_localctx).op02!=null?((ExprContext)_localctx).op02.getText():null).equals("==")) ? BinaryOperator.EQUALS :  BinaryOperator.GTE;
						                           ((ExprContext)_localctx).exprRet =  new BinaryExpr(((ExprContext)_localctx).e03.exprRet, op, ((ExprContext)_localctx).e04.exprRet);
						                           _localctx.exprRet.setLine((((ExprContext)_localctx).op02!=null?((ExprContext)_localctx).op02.getLine():0));
					...
					case 4:
						{
						_localctx = new ExprContext(_parentctx, _parentState);
						_localctx.e01 = _prevctx;
						pushNewRecursionContext(_localctx, _startState, RULE_expr);
						setState(140);
						if (!(precpred(_ctx, 3))) throw new FailedPredicateException(this, "precpred(_ctx, 3)");
						setState(141);
						((ExprContext)_localctx).op01 = _input.LT(1);
						_la = _input.LA(1);
						if ( !(_la==T__8 || _la==T__9) ) {
							((ExprContext)_localctx).op01 = (Token)_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
							_errHandler.reportMatch(this);
						...
						setState(142);
						((ExprContext)_localctx).e02 = expr(4);

						                               BinaryOperator  op = ((((ExprContext)_localctx).op01!=null?((ExprContext)_localctx).op01.getText():null).equals("&&")) ? BinaryOperator.AND :  BinaryOperator.OR;
						                               ((ExprContext)_localctx).exprRet =  new BinaryExpr(((ExprContext)_localctx).e01.exprRet, op, ((ExprContext)_localctx).e02.exprRet);
						                               _localctx.exprRet.setLine((((ExprContext)_localctx).op01!=null?((ExprContext)_localctx).op01.getLine():0));
	...
	public static class Primary_exprContext extends ParserRuleContext {
		...
		public TerminalNode CHAR_VAL() { return getToken(SimpleLangParser.CHAR_VAL, 0); }
	...
	public final Primary_exprContext primary_expr() throws RecognitionException {
		...
		try {
			...
			case CHAR_VAL:
				...
				{
				setState(168);
				((Primary_exprContext)_localctx).c = match(CHAR_VAL);
				 ((Primary_exprContext)_localctx).primary_expr_ret =  new CharVal((((Primary_exprContext)_localctx).c!=null?((Primary_exprContext)_localctx).c.getText():null)); _localctx.primary_expr_ret.setLine((((Primary_exprContext)_localctx).c!=null?((Primary_exprContext)_localctx).c.getLine():0));
				}
				break;
			default:
