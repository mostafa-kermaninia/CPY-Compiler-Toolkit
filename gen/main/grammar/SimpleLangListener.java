...
public interface SimpleLangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SimpleLangParser#helpExpr}.
	 * @param ctx the parse tree
	 */
	void enterHelpExpr(SimpleLangParser.HelpExprContext ctx);
	/**
	 * Exit a parse tree produced by {@link SimpleLangParser#helpExpr}.
	 * @param ctx the parse tree
	 */
	void exitHelpExpr(SimpleLangParser.HelpExprContext ctx);
}